...
Mapping_Dict = dict(
    Monsters = dict([ #ID is unit_master_id
        ...
        (21813, Add_Monster("Louise", "wind", "support")),
        (25211, Add_Monster("Nana", "water", "support")),
        (25613, Add_Monster("Riley", "wind", "support")),
        (15931, Add_Monster("Megan", "water", "support")),
        (16613, Add_Monster("Leo", "wind", "support")),
        (19011, Add_Monster("Talc", "water", "hp")),
        (20014, Add_Monster("Lucas", "light", "attack")),
        (20414, Add_Monster("Amarna", "light", "support")),
        (20713, Add_Monster("Windy", "wind", "support")),
        (23313, Add_Monster("Malite", "wind", "defense")),
        (25114, Add_Monster("Kinki", "light", "hp")),
        (25612, Add_Monster("Nora", "fire", "support")),
        (22211, Add_Monster("Abellio", "water", "defense")),
        (25911, Add_Monster("Minato", "water", "attack")),
        (13511, Add_Monster("Susano", "water", "attack")),
        (25912, Add_Monster("Ren", "fire", "attack")),
        (16813, Add_Monster("Xing Xhe", "wind", "hp")),
        (16035, Add_Monster("Thrain", "dark", "attack"))
    ]),
    Artifacts = dict([
        (400, "S1_CD"),
        (401, "S2_CD"),
